...
void TestConstructorRender() {
    ...
    PNG inimg;
    inimg.readFromFile("images-orig/3x4.png");
    ...
    if (inimg.height() == 4 && inimg.width() == 3) {
        ...
        outputimg.writeToFile("images-output/3x4-r_0_0.png");
        cout << "done." << endl;
...
void TestCarveMode0() {
    ...
    PNG inimg;
    inimg.readFromFile("images-orig/5x6.png");
    ...
    if (inimg.height() == 6 && inimg.width() == 5) {
        ...
        outputimg1.writeToFile("images-output/5x6-c_1_0-r_0_0.png");
        cout << "done." << endl;
        ...
        outputimg2.writeToFile("images-output/5x6-c_1_0-r_1_0.png");
        cout << "done." << endl;
        ...
        outputimg3.writeToFile("images-output/5x6-c_1_0-r_1_1.png");
        cout << "done." << endl;
        ...
        outputimg4.writeToFile("images-output/5x6-c_2_0-r_0_0.png");
        cout << "done." << endl;
        ...
        outputimg5.writeToFile("images-output/5x6-c_2_0-r_1_2.png");
        cout << "done." << endl;
...
void TestRenderMode2() {
    ...
    PNG inimg;
    inimg.readFromFile("images-orig/6x6grad.png");
    ...
    if (inimg.height() == 6 && inimg.width() == 6) {
        ...
        outputimg1.writeToFile("images-output/6x6-c_12_0-r_0_0.png");
        cout << "done." << endl;
        ...
        outputimg2.writeToFile("images-output/6x6-c_12_0-r_1_2.png");
        cout << "done." << endl;
