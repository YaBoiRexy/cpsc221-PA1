    ...
    class RGBAPixel {
        public:
            ...
            **/
            ...
            /**
             * Constructs an RGBAPixel with the given red, green, blue, 
             * and alpha values.
             *
             * @param red value for the new pixel, in [0, 255].
             * @param green value for the new pixel, [0, 255].
            ...
            **/
            ...
            /**
             * Computes the color "distance" between this pixel and other.
             * @param other pixel whose color will be compared to this pixel
            **/
            double distanceTo(const RGBAPixel& other) const;
    };
